    ...
    <article class="row format-standard">
        ...
        <div class="col-full s-content__main">
            ...
            <?php
                ...
                $philosophy_page_upload_meta = get_post_meta( get_the_ID(), 'page_metabox_upload', true );
                $philosophy_image_id = $philosophy_page_upload_meta['page_upload'];
                $philosophy_page_upload_image = $philosophy_page_upload_meta['page_upload_image'];
                $philosophy_page_upload_gallery = $philosophy_page_upload_meta['opt_gallery'];
                $philosophy_page_upload_gallery_ids = explode( ',', $philosophy_page_upload_gallery );

                echo __( $philosophy_image_id, 'philosophy' ) . '<br>';
                echo __( $philosophy_page_upload_image, 'philosophy' ) . '<br>';
                echo wp_get_attachment_image( $philosophy_page_upload_image, 'medium' ) . '<br>';

                if ( $philosophy_page_upload_gallery_ids ) {
                ?>
                    <div class="my-slider">
                    <?php
                        foreach ( $philosophy_page_upload_gallery_ids as $philosophy_page_upload_gallery_id ) {
                                echo "<div>";
                                echo wp_get_attachment_image( $philosophy_page_upload_gallery_id, 'large' ) . '<br>';
                                echo "</div>";
                            }
                        ?>
                    </div>
